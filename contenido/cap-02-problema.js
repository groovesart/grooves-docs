  ...
  es: `
    ...
    <div class="figure reflow">
      <svg viewBox="0 0 600 250" xmlns="http://www.w3.org/2000/svg" class="sec-svg svg-desktop">
        ...
        <text x="150" y="172" text-anchor="middle" fill="#c0563f" font-size="20" font-family="'Outfit',sans-serif" font-weight="600">$0</text>
      ...
      <svg viewBox="0 0 300 430" xmlns="http://www.w3.org/2000/svg" class="svg-mobile">
        ...
        <text x="150" y="133" text-anchor="middle" fill="#c0563f" font-size="19" font-family="'Outfit',sans-serif" font-weight="600">$0</text>
