...
registerChapter('como-funciona', {
  ...
  es: `
    ...
    <p class="ch-lead">Para que Grooves sea accesible a cualquier fan y artista —no solo a quienes ya entienden de criptografía— la plataforma reduce la fricción al mínimo: explorar y escuchar previews no requiere wallet, y para poseer basta conectar la propia con un clic. La complejidad de la blockchain —el gas, las redes, la jerga— queda invisible.</p>
    ...
    <ol>
      ...
      <li><strong>Adquiere Pressings.</strong> Conecta tu wallet con un clic y compra directamente del artista o en el mercado secundario.</li>
  ...
  en: `
    ...
    <p class="ch-lead">For Grooves to be accessible to any fan and artist — not just those who already understand cryptography — the platform keeps friction to a minimum: exploring and listening to previews needs no wallet, and to own, you simply connect your own in one click. The blockchain's complexity — gas, networks, jargon — stays invisible.</p>
    ...
    <div class="figure">
      ...
      <svg viewBox="0 0 300 360" class="svg-mobile" xmlns="http://www.w3.org/2000/svg">
        ...
        <g font-family="'Spline Sans',sans-serif" font-size="13" fill="#c9c6bd">
          ...
          <g><circle cx="36" cy="180" r="15" fill="#131318" stroke="#C8A96E" stroke-width="1.6"/><text x="36" y="185" text-anchor="middle" fill="#C8A96E" font-family="'JetBrains Mono'">3</text><text x="64" y="185">Play your collection</text></g>
          <g><circle cx="36" cy="252" r="15" fill="#131318" stroke="#C8A96E" stroke-width="1.6"/><text x="36" y="257" text-anchor="middle" fill="#C8A96E" font-family="'JetBrains Mono'">4</text><text x="64" y="257">Unlock your rights</text></g>
          <g><circle cx="36" cy="324" r="15" fill="#2e2a1a" stroke="#C8A96E" stroke-width="1.6"/><text x="36" y="329" text-anchor="middle" fill="#C8A96E" font-family="'JetBrains Mono'">5</text><text x="64" y="329">Resell if you wish</text></g>
        </g>
      </svg>
    ...
    <ol>
      ...
      <li><strong>Acquire Pressings.</strong> Connect your wallet in one click and buy directly from the artist or on the secondary market.</li>
