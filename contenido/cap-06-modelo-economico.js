    ...
    <div class="figure">
      <svg viewBox="0 0 460 240" class="svg-desktop" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(120,120)">
          ...
          <text y="-4" text-anchor="middle" fill="#C8A96E" font-family="'Fraunces',serif" font-size="30" font-weight="600">95%</text>
      ...
      <svg viewBox="0 0 300 300" class="svg-mobile" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(150,100)">
          ...
          <text y="-2" text-anchor="middle" fill="#C8A96E" font-family="'Fraunces',serif" font-size="28" font-weight="600">95%</text>
