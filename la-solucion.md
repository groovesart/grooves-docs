...
Un Pressing no es simplemente un archivo de audio digitalizado. Es un **objeto digital autenticado que funciona como llave de acceso** a todo un universo creativo definido por el artista o el sello. Cada Pressing está registrado en blockchain, lo que garantiza tres propiedades fundamentales:
...
> Un músico independiente crea un Sealed Edition de 300 Pressings de su nuevo álbum. Cada Pressing da acceso al álbum completo en calidad lossless, pero también a un podcast exclusivo de 8 episodios donde el artista cuenta la historia detrás de cada canción, acceso anticipado a las entradas de su próxima gira, y un canal privado de Discord donde interactúa directamente con los 300 poseedores. Si el artista crece, esos 300 Pressings se revalorizan — y cada reventa le genera royalties automáticos.

### Ejemplo: Sello discográfico grande — Catálogo Histórico como Experiencia

> Un gran sello crea un Sealed Edition de 10,000 Pressings llamado "The Vinyl Vault: Los 70s". Cada Pressing desbloquea el catálogo completo de la década, sesiones de estudio remasterizadas nunca publicadas, un documental exclusivo sobre la época, y acceso a listening parties virtuales con productores legendarios. El sello genera ingresos directos masivos en lugar de fracciones de centavo por stream, y cobra royalties en cada reventa futura.

### Ejemplo: Banda emergente — Acceso a la Comunidad

> Una banda crea un Open Edition sin límite. Cada Pressing cuesta $5 y da acceso al EP, pero también a un grupo privado donde la banda comparte demos, vota con los fans sobre el setlist de conciertos, y ofrece descuentos en merch. A medida que la banda crece, añade más contenido vinculado al Pressing: versiones en vivo, colaboraciones, behind-the-scenes. El Pressing se convierte en un objeto vivo que evoluciona con la carrera del artista.
...
| **Contenido evolutivo** | El artista añade contenido nuevo con el tiempo | Remixes futuros, versiones en vivo, colaboraciones, BTS |
| **Merch & físicos** | Descuentos o acceso prioritario a mercancía | 20% de descuento en la tienda, acceso anticipado a vinilos |
...
4. **Configura tu Edition.** Sealed u Open, precio, porcentaje de royalty, contenido vinculado.
...
4. **Accede a tus derechos.** Podcasts, videos, entradas a eventos, comunidades — todo lo vinculado a tu Pressing.
5. **Revende si lo deseas.** Si un artista explota, tu Pressing se revaloriza. El artista cobra royalty en cada reventa.

---

## 3.6 — Onboarding sin Fricción: Pagar sin Saber de Cripto

Para que Grooves sea accesible a cualquier fan y artista — no solo a los que ya entienden de criptomonedas — la plataforma elimina toda fricción técnica del proceso de compra y registro.

### Wallet automática

Cuando un usuario crea su cuenta en Grooves con email o redes sociales, la plataforma genera automáticamente una wallet en segundo plano. El usuario no necesita instalar MetaMask, entender qué es una seed phrase, ni interactuar con ninguna interfaz de blockchain. Su wallet existe, está segura, y funciona — pero es invisible.
